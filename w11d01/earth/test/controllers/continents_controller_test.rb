...
class ContinentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create continent" do
    assert_difference('Continent.count') do
      post continents_url, params: { continent: { highpoint_elevation: @continent.highpoint_elevation, highpoint_name: @continent.highpoint_name, lowpoint_elevation: @continent.lowpoint_elevation, lowpoint_name: @continent.lowpoint_name, name: @continent.name } }
    end
  ...
  test "should update continent" do
    patch continent_url(@continent), params: { continent: { highpoint_elevation: @continent.highpoint_elevation, highpoint_name: @continent.highpoint_name, lowpoint_elevation: @continent.lowpoint_elevation, lowpoint_name: @continent.lowpoint_name, name: @continent.name } }
